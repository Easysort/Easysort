...
if __name__ == "__main__":
    ...
    # stov_images = []
    # sorte_poser_images = []
    # genbrug_images = [helper.upload_sequence_artifact("easysort/tracking/demo_data/2/Genbrug1.png"), helper.upload_sequence_artifact("easysort/tracking/demo_data/2/Genbrug2.png")]
    ...
    stov_images = [helper.upload_sequence_artifact("easysort/tracking/demo_data/4/dust.png"), helper.upload_sequence_artifact("easysort/tracking/demo_data/4/dust2.png")]
    sorte_poser_images = []
    genbrug_images = []
