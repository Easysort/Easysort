...
def get_matching_config_string(robot_config: RobotConfig, value: str | int | List[int]) -> str:
    return next((key for key, config_value in vars(robot_config).items() if config_value == value), None)
