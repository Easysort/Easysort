...
OPENAI_API_KEY, GEMINI_API_KEY, OPENROUTER_API_KEY = getenv("OPENAI_API_KEY", ""), getenv("GEMINI_API_KEY", ""), getenv("OPENROUTER_API_KEY", "")
...
class Concat:
  ...
  def _summary(items: list[tuple[datetime.datetime, Any]], loc_key: str, seed: str, filter_personal: bool | None = None) -> dict:
    ...
    obj_f, w_f, c_f = Concat._ARGO_FACTORS.get(Concat._loc_id(loc_key), (1.0, 0.6, 0.2))
