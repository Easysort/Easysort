...
class TestRegistry(unittest.TestCase):
    _srv: AbstractContextManager[str]
    _base: str
    ...
    def setUp(self):
        ...
        self.dummy_dataclass = make_dataclass("dummy1", [("id", str), ("dummy", str), ("metadata", RegistryBase.BaseDefaultTypes.BASEMETADATA)])
        self.dummy_dataclass2 = make_dataclass("dummy2", [("id", str), ("dummy2", str), ("metadata", RegistryBase.BaseDefaultTypes.BASEMETADATA)])
    ...
    def test_GET_ref_not_found(self):
        ...
        self.assertRaises(FileNotFoundError, self.registry.GET, Path("test.json"), \
            self.registry.DefaultMarkers.REF_MARKER, ref=Path("nonexistent.png"))
