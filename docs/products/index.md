...
NIR scanners are an excellent way to perform this after the initial sorting. They are highly accurate, reliable and testet in the waste industry, which makes then a good investment case. But we still have massive data gap to fill, as the following questions need to be answered:

1. What is the composition of the waste stream coming in?
2. What are the NIR scanners missing? (objects, fractions, purity, etc)
3. Does the composition of the waste stream change / shift daily / weekly?
4. How are our processes besides sorting working? How effective are they?

To answer this we need more general, portable detection systems that can be put around the facility to give operators information, and in the long term automatically detect, adjust and optimize.
...
0. Facility-wide detection system to give more information and provide foundation for AI detection systems.
...
What is the real big hurdle that would have the largest effect on such facility actually being built? High quality AI detection systems and facility-wide detection systems. So this is what we are building.
