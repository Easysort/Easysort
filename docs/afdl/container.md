...
## Resumé
Easysort overvåger containere og genbrugstelte med kamera og AI for løbende at vurdere indhold, aktivitet og kvalitet. Løsningen skaber gennemsigtighed i, hvad der reelt afleveres, hvor ofte fejlsorteringer forekommer, og hvordan tiltag påvirker resultaterne over tid. 
...
Denne information kan både bruges af driftsledere og omlasteplads til bedste af behandle og optimere sorteringen.
...
Systemet kan overvåge containere med større fraktioner som f.eks. træ, metal, beton, pap og papir og plast. Systemet identificerer derfor ikke kun affaldsfraktioner, men også materialer, der er sorteret forkert (såsom hårde hvidevarer, behandlet træ, møbler, presenninger, plastik spande, m.m.)

## Genbrugstelte (udvidet anvendelse)
...
- **Rapportering**: Hvor meget CO2 spares ved den dokumenterede aktivitet og forbedret adfærd?
...
Det er muligt at få prøvet systemet af med én fraktion eller et telt. Dette kan gøres via vores testfase, hvor vi kan opsætte systemet på én container eller et telt og overvåge det i en måned for at se, om det giver den ønskede værdi.

## Pris

Systemet koster 10.000 kr. pr. camera i opsætning og derefter 2.000-8.000 kr. pr. camera pr. måned i drift (ekskl. moms).

Der skal typisk bruge 1 camera pr. container. Her koster systemet 2.000 kr. pr. måned.

Der skal typisk bruge 1 camera pr. indgang til genbrugstelte. Den månedlige pris er her afhængig af, hvor mange dagligt besøgende, der er på pladsen.
